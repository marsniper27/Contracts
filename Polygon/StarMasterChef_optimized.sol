...
contract StarSeedsMasterchef is Ownable, ReentrancyGuard {
    ...
    // The STAR TOKEN!
    address public constant star = 0x8440178087C4fd348D43d0205F4574e0348a06F0;
...
//////////// onlyOperator functions //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function updateEmissionRate(uint256 _starPerBlock) external onlyOperator {
...
//////////// User functions //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function harvestStar(uint256 _pid) external nonReentrant{
        PoolInfo storage pool = poolInfo[_pid];
        UserInfo storage user = userInfo[_pid][msg.sender];
